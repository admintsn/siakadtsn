...
use App\Filament\Exports\CitaExporter;
use App\Filament\Imports\CitaImporter;
use App\Models\Cita;
use Filament\Forms;
...
class CitaResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Cita-cita';

    protected static ?string $pluralModelLabel = 'Cita-cita';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            ->schema(static::CitaCitaFormSchema());
    }

    public static function CitaCitaFormSchema(): array
    {
        return [

            Section::make('Cita-cita')
                ->schema([
                    ...
                    Grid::make(4)
                        ->schema([
                            ...
                            TextInput::make('cita')
                                ->label('Cita-cita')
                                ->required()
                                ->unique(Cita::class, ignoreRecord: true),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Cita-cita', [

                    TextColumn::make('cita')
                        ->label('Cita-cita')
