...
use App\Filament\Admin\Resources\DataAlumniResource\Pages;
use App\Filament\Admin\Resources\DataAlumniResource\RelationManagers;
use App\Models\Cita;
...
class DataAlumniResource extends Resource
{
    ...
    protected static ?int $navigationSort = 300000001;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            ->schema(static::DataAlumniFormSchema());
    }

    public static function DataAlumniFormSchema(): array
    {
        return [
    ...
    {
        return [
            'index' => Pages\ListDataAlumnis::route('/'),
            'create' => Pages\CreateDataAlumni::route('/create'),
            'view' => Pages\ViewDataAlumni::route('/{record}'),
            'edit' => Pages\EditDataAlumni::route('/{record}/edit'),
        ];
    }
