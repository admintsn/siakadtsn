...
use App\Filament\Imports\JenisSuratImporter;
...
class JenisSuratResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            ->schema(static::JenisSuratFormSchema());
    }

    public static function JenisSuratFormSchema(): array
    {
        return [
                    ...
                    Grid::make(4)
                        ->schema([
                            ...
                            TextInput::make('kode')
                                ...
                                ->required()
                                ->unique(JenisSurat::class, ignoreRecord: true),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ...
                ImportAction::make()
                    ->label('Import')
                    ->importer(JenisSuratImporter::class)
            ])
            ->actions([
                ActionGroup::make([
