...
class KelasResource extends Resource
{
    ...
    protected static ?int $navigationSort = 800000100;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            ->schema(static::KelasFormSchema());
    }

    public static function KelasFormSchema(): array
    {
        return [
                ...
                ->schema([
                    ...
                    Grid::make(4)
                        ->schema([
                            ...
                            TextInput::make('abbr_kelas')
                                ->label('Kelas')
                                ->required()
                                ->unique(Kelas::class, ignoreRecord: true),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Kelas', [

                    TextColumn::make('abbr_kelas')
                        ->label('Kelas')
            ...
            ->filters([
                QueryBuilder::make()
                    ...
                    ->constraints([
                        ...
                        TextConstraint::make('abbr_Kelas')
                            ->label('Kelas')
                            ->nullable(),

                        TextConstraint::make('kelas')
                            ->label('Desc')
                            ->nullable(),
