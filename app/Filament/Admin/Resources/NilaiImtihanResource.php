...
use App\Filament\Admin\Resources\NilaiImtihanResource\Pages;
use App\Filament\Admin\Resources\NilaiImtihanResource\RelationManagers;
...
class NilaiImtihanResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Nilai Imtihan';

    protected static ?string $pluralModelLabel = 'Nilai Imtihan';

    protected static ?string $navigationLabel = 'Nilai Imtihan';

    protected static ?int $navigationSort = 400000100;
    ...
    {
        return [
            'index' => Pages\ListNilaiImtihans::route('/'),
            'create' => Pages\CreateNilaiImtihan::route('/create'),
            'view' => Pages\ViewNilaiImtihan::route('/{record}'),
            'edit' => Pages\EditNilaiImtihan::route('/{record}/edit'),
        ];
    }
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return parent::getEloquentQuery()->where('is_nilai', true)->where('tahun_berjalan_id', $tb->id)->where('semester_berjalan_id', $sm->id);
    }
}
