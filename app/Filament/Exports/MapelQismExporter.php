...
class MapelQismExporter extends Exporter
{
    ...
    {
        $body = 'Your mapel qism export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
